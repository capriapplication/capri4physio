        ...
        holder.ll_cource.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(is_billing) {
                    ...
                    intent.putExtra("coursePOJO",horizontalList.get(position));
                    activity.startActivity(intent);
                }
                else{
                    try {
                        int seat_avail = Integer.parseInt(horizontalList.get(position).getRemSeat());
                        if (seat_avail > 0) {
        ...
        holder.tv_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    intent.setData(Uri.parse("tel:" + horizontalList.get(position).getPhone()));
