...
//                                && ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.VIBRATE)
    ...
    public void makesplash() {
        if(Pref.GetBooleanPref(getApplicationContext(), StringUtils.IS_STUDENT_LOGIN,false)) {
            Gson gson=new Gson();
            StudentUserPOJO studentUserPOJO=gson.fromJson(Pref.GetStringPref(getApplicationContext(),StringUtils.STUDENT_POJO,""),StudentUserPOJO.class);
            startActivity(new Intent(SplashActivity.this,StudentDashboardActivity.class).putExtra("studentPOJO",studentUserPOJO));
            finishAffinity();
        }else if(Pref.GetBooleanPref(getApplicationContext(), StringUtils.IS_ADMIN_LOGIN,false)){
            Gson gson=new Gson();
            AdminUserPOJO adminUserPOJO=gson.fromJson(Pref.GetStringPref(getApplicationContext(),StringUtils.ADMIN_POJO,""),AdminUserPOJO.class);
