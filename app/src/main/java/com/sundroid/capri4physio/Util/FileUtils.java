...
public class FileUtils {
    public static String BASE_FILE_PATH = Environment.getExternalStorageDirectory().toString() + File.separator + "caprispine";
    ...
    public static String getPatientAssessmentDir() {
        try {
            String base_path = getBaseFilePath();
            if (base_path != null) {
                File f = new File(base_path + File.separator + "assessment");
                if (!f.exists())
                    f.mkdirs();
                return f.getPath();
            } else {
    ...
    public static final String getreportDir() {
        try {
            String base_path = getBaseFilePath();
            File f = new File(base_path + File.separator + "report");
            if (!f.exists()) {
                f.mkdirs();
            }
            return f.toString();
    ...
    public static String getTempImageDir() {
        try {
            String base_path = getBaseFilePath();
            if (base_path != null) {
                File f = new File(base_path + File.separator + "temp_image");
                if (!f.exists())
                    f.mkdirs();
                return f.getPath();
            } else {
    ...
    public static String getMediaDir() {
        try {
            String base_path = getChatDirPath();
            if (base_path != null) {
                File f = new File(base_path + File.separator + "media");
                if (!f.exists())
                    f.mkdirs();
                return f.getPath();
            } else {
